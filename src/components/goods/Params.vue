<!--
 * @Author: your name
 * @Date: 2020-09-03 17:26:10
 * @LastEditTime: 2020-09-04 21:16:45
    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="动态参数" name="many">
          <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addDialogVisable=true">添加参数
          </el-button>
          <!-- 动态参数表格 -->
        ...
        <el-tab-pane label="静态属性" name="only">
          <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addDialogVisable=true">添加属性
          </el-button>
          <!-- 静态属性表格 -->
...
export default {
  ...
  methods: {
    ...
    async getParamsData () {
      ...
      // 遍历每一条参数，将里面的attr_vals字符串变成数组，方便以后渲染使用；还有为每一条数据对象新填两个属性inputVisible和inputValue，使其独立开
